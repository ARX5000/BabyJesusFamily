        ...
        <form method="POST" action="{{ route('admin.students.update', $student) }}" class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                ...
                <div>
                    ...
                    <input type="text" name="phone" value="{{ old('phone', $student->phone) }}" class="form-input" placeholder="01XXXXXXXXX">
                ...
                <div>
                    ...
                    <select name="status" class="form-input">
                        <option value="pending"  {{ old('status', $student->status) === 'pending'  ? 'selected' : '' }}>قيد الانتظار</option>
                        <option value="approved" {{ old('status', $student->status) === 'approved' ? 'selected' : '' }}>مقبول</option>
                        <option value="rejected" {{ old('status', $student->status) === 'rejected' ? 'selected' : '' }}>مرفوض</option>
                    </select>
                ...
                <div>
                    ...
                    <input type="text" name="parent_phone" value="{{ old('parent_phone', $student->parent_phone) }}" class="form-input" placeholder="01XXXXXXXXX">
            ...
            <div class="flex items-center gap-3 pt-2">
                ...
                <a href="{{ route('admin.students.show', $student) }}" class="btn-secondary">إلغاء</a>
            </div>
        </form>
    </div>
</div>
